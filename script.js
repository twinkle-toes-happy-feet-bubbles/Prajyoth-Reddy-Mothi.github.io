$(() => {
  ...
  function audioSelect(e){
    ...
    switch(e.target.id){
      case "forest": $audio.attr("src", "forest.mp3"); break;
      case "ocean": $audio.attr("src", "ocean.mp3"); break;
      case "rainy": $audio.attr("src", "rain.mp3"); break;
      case "peace": $audio.attr("src", "peace.mp3"); break;
      case "cafe": $audio.attr("src", "cafe.mp3"); break;
    }
  }
